...
// Helper component for transaction detail rows
const DetailRow: React.FC<{ icon: React.ReactNode; label: string; value: string; isBold?: boolean }> = ({ icon, label, value, isBold = false }) => (
                        ...
                        <div className="lg:col-span-3">
                            ...
                            <section>
                                ...
                                <div className="divide-y divide-slate-700">
                                    <DetailRow
                                        icon={<ClipboardListIcon className="h-5 w-5 text-slate-500" />}
