...
@section("title", "UpSkills - Success Checkout")
@section("content")
  ...
  <main class="flex justify-center py-5 flex-1 items-center">
    <div class="w-[500px] flex flex-col gap-[30px]">
      <div class="flex flex-col gap-[10px]">
        ...
        <p class="text-center leading-[28px] text-obito-text-secondary">Anda telah memiliki akses kelas materi terbaru
          sebagai persiapan bekerja di era digital industri saat ini, yay!</p>
      </div>
      <section id="card"
