...
@section("title", "UpSkills - Register")
    ...
    <main class="relative flex flex-1 h-full">
            ...
            <form action="{{ route('register') }}" enctype="multipart/form-data" method="POST"
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <label class="relative group">
                        ...
                        <img src="{{asset('assets/images/icons/profile.svg') }}"" class=" absolute size-5 flex shrink-0
                            transform -translate-y-1/2 top-1/2 left-5" alt="icon">
                    </label>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <label class="relative group">
                        ...
                        <img src="{{asset('assets/images/icons/briefcase.svg') }}"" class=" absolute size-5 flex shrink-0
                            transform -translate-y-1/2 top-1/2 left-5" alt="icon">
                    </label>
                    <x-input-error :messages="$errors->get('occupation')" class="mt-2 text-red-500" />
                </div>
                <div class="flex flex-col gap-2">
                    <p>Email Address</p>
                    <label class="relative group">
                        ...
                        <img src="{{asset('assets/images/icons/sms.svg') }}"" class=" absolute size-5 flex shrink-0
                            transform -translate-y-1/2 top-1/2 left-5" alt="icon">
                    </label>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <label class="relative group">
                        ...
                        <img src="{{asset('assets/images/icons/shield-security.svg') }}"" class=" absolute size-5 flex
                            shrink-0 transform -translate-y-1/2 top-1/2 left-5" alt="icon">
                    </label>
        ...
        <div class="relative flex w-1/2 shrink-0">
            <div id="background-banner" class="absolute flex w-full h-full overflow-hidden">
                <img src="{{asset('assets/images/backgrounds/banner-subscription.png') }}"" class=" w-full h-full
                    object-cover" alt="banner">
            </div>
        </div>
    </main>
