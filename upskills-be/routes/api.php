...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::delete('/courses/{course}/complete', [\App\Http\Controllers\CourseCompletionController::class, 'destroy'])->name('api.courses.complete.delete');
    ...
    // Mentor Messages
    Route::post('/mentor-messages', [\App\Http\Controllers\MentorMessageController::class, 'store'])->name('api.mentor-messages.store');
    ...
    // Checkout success - HARUS di luar middleware role:student
    // Karena user mungkin belum punya role saat checkout atau ada masalah dengan role
    ...
    Route::middleware('role:student')->group(function () {
        ...
        // Checkout (requires student role)
