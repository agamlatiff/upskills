...
const SignIn: React.FC = () => {
    ...
    const [touched, setTouched] = useState<Partial<Record<keyof SignInData, boolean>>>({});
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (touched[name as keyof SignInData]) {
            validateForm(newFormData);
        }
    };

    const handleBlur = (e: React.FocusEvent<HTMLInputElement>) => {
        const { name } = e.target as { name: keyof SignInData };
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-md mx-auto">
                    <div className="text-center mb-10">
                        ...
                        <p className="mt-4 text-lg text-slate-400">Sign in to continue your learning journey.</p>
                    </div>
